...
:start
	echo Launching forge-1.12.2-14.23.5.2847-universal.jar with arguments '%*' and '%mem%' max memory

	:: add nogui to the end of this line to disable the gui ::
	java -Xmx%mem% -XX:MaxPermSize=256M -jar forge-1.12.2-14.23.5.2847-universal.jar %* nogui

	set /a crashcount -= 1

echo CRASH DETECTED

if %crashcount% GTR 0 goto start
